...
# Margin Fixed 5ns
set_input_delay  -clock clock_clk -clock_rise -add_delay [expr $period_clk - 5] [all_inputs]
# Margin Fixed 5ns
set_output_delay -clock clock_clk -clock_rise -add_delay [expr $period_clk - 5] [all_inputs]
