...
//*        Library Name   : ts1n65lpa4096x8m8r (user specify : TS1N65LPA4096X8M8)
...
S11000X8_RAM_1bit sram_IO0 (CLK, iCEB, iWEB, iBWEB[0], iA, iD[0], Q_tmp[0]);
S11000X8_RAM_1bit sram_IO1 (CLK, iCEB, iWEB, iBWEB[1], iA, iD[1], Q_tmp[1]);
S11000X8_RAM_1bit sram_IO2 (CLK, iCEB, iWEB, iBWEB[2], iA, iD[2], Q_tmp[2]);
S11000X8_RAM_1bit sram_IO3 (CLK, iCEB, iWEB, iBWEB[3], iA, iD[3], Q_tmp[3]);
S11000X8_RAM_1bit sram_IO4 (CLK, iCEB, iWEB, iBWEB[4], iA, iD[4], Q_tmp[4]);
S11000X8_RAM_1bit sram_IO5 (CLK, iCEB, iWEB, iBWEB[5], iA, iD[5], Q_tmp[5]);
S11000X8_RAM_1bit sram_IO6 (CLK, iCEB, iWEB, iBWEB[6], iA, iD[6], Q_tmp[6]);
S11000X8_RAM_1bit sram_IO7 (CLK, iCEB, iWEB, iBWEB[7], iA, iD[7], Q_tmp[7]);
...
// 1 bit SRAM 
module S11000X8_RAM_1bit (CLK_i, CEB_i, WEB_i, BWEB_i, A_i, D_i, Q_i);
